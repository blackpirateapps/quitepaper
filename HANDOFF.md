...
- [x] Heading whitespace preservation: Whole-remainder inline parsing and adjacent identical-style span merging ensure all spaces typed immediately after hashes (`#`) and throughout heading sentences appear instantly at their full layout width without collapsing or delay.
